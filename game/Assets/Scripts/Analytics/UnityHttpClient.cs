...
public class UnityHTTPClient : HTTPClient
{
  ...
  public UnityHTTPClient(MainThreadDispatcher dispatcher, string apiKey, string apiHost = null, string cdnHost = null) : base(apiKey, apiHost, cdnHost)
  {
...
public class UnityHTTPClientProvider : IHTTPClientProvider
{
  ...
  {
    return new UnityHTTPClient(_dispatcher, apiKey, apiHost, cdnHost);
  }
}
